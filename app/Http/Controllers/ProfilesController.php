...
class ProfilesController extends Controller
{
    ...
    public function getUserByUsername($username)
    {
       // return User::with('profile')->wherename($username)->firstOrFail();
        return User::with('profile')->where('name',$username)->firstOrFail();
     ...
     */
     function updateUserAccount(Request $request, $id)
    {
   ...
   function upload() {
     ...
     * @return string
     */
   function userProfileAvatar($id, $image)
    {
     ...
     * @return \Illuminate\Http\Response
     */
   function deleteUserAccount(Request $request, $id)
    {
     ...
     * @return void
     */
   function sendGoodbyEmail(User $user, $token) {
